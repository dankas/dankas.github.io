...
image:
  feature: img/Screenshotpowrbi.JPG
---
...
Faltava alguma dependência para conectar o banco. A solução para isso é simplesmente atualizar o DOTNet Connector disponibilizado pelo MySQL, para isso basta ir no **MySQL Installer** ou entrar neste link: [link](https://dev.mysql.com/downloads/connector/net/).
